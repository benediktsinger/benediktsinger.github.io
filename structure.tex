...
\sectionfont{\fontsize{16pt}{12pt}\selectfont} % Set font options for sections
\subsectionfont{\fontsize{14pt}{14pt}\selectfont} % Set font options for subsections
\subsubsectionfont{\fontsize{14pt}{14pt}\selectfont} % Set font options for subsubsections
...
\setlength{\marginparsep}{-9pt} % Move the margin content closer to the text
